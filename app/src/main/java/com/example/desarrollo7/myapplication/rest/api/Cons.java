...
public class Cons {
    ...
    public static final String URL_ALL_CHARACTERS = API + ALL_CHARACTERS;
    public static final String URL_ONE_CHARACTERS = API + CHARACTER + "{id}";
    public static final String GET = API + ALL_CHARACTERS + APIKEY + MARVEL_DEVELOPER_APIKEY + HASH + MARVEL_DEVELOPER_HASH + OFFSET + TIMESTAMP + MARVEL_DEVELOPER_TIMESTAMP;
